...
import classes from "./SimpleFormHotels.module.css"
import CustomInput from "../../../../components/CustomInput/CustomInput";
const { Option } = Select;
const title = 'Choose your best hotel';

const SimpleFormHotels = (props) => {
    return (
        <React.Fragment>
            ...
            <Form className={`${classes.form} ${props.size}`}>
                    ...
                    <Form.Row className={classes.bottomRow}>
                        <CustomInput
                            classes={`${classes.item} ${props.classes} ${props.size}`}
                            controlId="formGridCheckInHotels"
                            name="name"
                            dark={(props.dark == true) ?  true : null}
                        ...
                        <CustomInput
                            classes={`${classes.item} ${props.classes} ${props.size}`}
                            controlId="formGridCheckOutHotels"
                            name="name"
                            dark={(props.dark == true) ?  true : null}
                        ...
                        <Form.Group controlId="formGridAdultHotels">
                        ...
                        <Form.Group controlId="formGridKidsHotels" >
...
export default SimpleFormHotels